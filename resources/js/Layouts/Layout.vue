...
<div class="bg-gray-100 font-family-karla flex">
    <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        ...
        <nav class="text-white text-base font-semibold pt-3"> 
            <Link :href="route('home')" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item"> 
    ...
    <ModalComponent :isOpen="isModalOpened" @modal-close="closeModal" name="first-modal">
        <template #header>Find Member</template>
...
import FindUserModalBody from '../Components/FindUserModalBody.vue';
import { ref } from 'vue';
